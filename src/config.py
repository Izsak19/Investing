...
EDGE_POLICY_POSITION_BOOST = 0.0
EDGE_POLICY_TP_BOOST = 0.0
...
PROFILES = {
    ...
    "tf_5m_edge_policy": {
        ...
        "USE_ATR_EXITS": False,
        "TRAILING_STOP_PCT": 0.03,
        "MAX_POSITION_HOLD_STEPS": 180,

        "ENABLE_TREND_EXIT": True,
        "TREND_EXIT_COL": "trend_48",
        "TREND_EXIT_LONG_MAX": -0.0005,
        "TREND_EXIT_SHORT_MIN": 0.0005,
        "TREND_EXIT_STREAK": 3,

        "POSITION_FRACTION_MIN": 0.12,
        "POSITION_FRACTION_MAX": 0.45,
        ...
        "EDGE_GATE_L2": 1e-3,
        "EDGE_GATE_TARGET_CLIP": 0.02,
        "EDGE_GATE_TARGET_HORIZON": 12,
        "EDGE_GATE_TARGET_MIN_ABS": 0.0012,
        "EDGE_GATE_MIN_EDGE": 0.12,
        "ENABLE_EDGE_POLICY": True,
        "EDGE_POLICY_MIN_EDGE": 0.18,
        "EDGE_POLICY_SIGN_ONLY": False,
        "EDGE_POLICY_POSITION_BOOST": 1.2,
        "EDGE_POLICY_TP_BOOST": 1.0,
        "ENABLE_FLAT_UNFREEZE": False,
        "STOP_LOSS_COOLDOWN_STEPS": 0,
        "ENABLE_KILL_SWITCH": True,
        "KILL_SWITCH_MIN_SELL_LEGS": 80,
        "KILL_SWITCH_EXPECTANCY_PNL_PER_SELL_LEG": -0.05,
        "KILL_SWITCH_MAX_DRAWDOWN": 0.12,
        "KILL_SWITCH_MAX_TRADES": 1200,
    },
}
